...
void createDeviceLocalResources() {
  ...
  void* reiChikitaData = stbi_load(SOURCE_DIR "dependencies/TuranLibraries/shaders/reiChikita.jpg", &reiChikitaWHC.x,
...
void compileShadersandPipelines() {
  // Compile compute shader, create binding table type & compute pipeline
  {
    const char* shaderText =
      filesys->funcs->read_textfile(SOURCE_DIR "dependencies/TuranLibraries/shaders/firstComputeShader.comp");
  ...
  // Compile first vertex-fragment shader & raster pipeline
  {
    ...
    const char* vertShaderText =
      filesys->funcs->read_textfile(SOURCE_DIR "dependencies/TuranLibraries/shaders/firstShader.vert");
    ...
    const char* fragShaderText =
      filesys->funcs->read_textfile(SOURCE_DIR "dependencies/TuranLibraries/shaders/firstShader.frag");
